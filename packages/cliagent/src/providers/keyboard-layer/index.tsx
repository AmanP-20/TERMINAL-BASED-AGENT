...
export function KeyboardLayerProvider({ children }: { children: React.ReactNode }) {
    ...
    // Required reference to safely read the stack state inside the keyboard event handler
    ...
    // You will need to return the Context Provider here to wrap the children:
    return (
